/****************************************************************************
** Meta object code from reading C++ file 'SerialPortMenager.h'
**
...
#error "The header file 'SerialPortMenager.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(4, 43, 13), // "errorOccurred"
QT_MOC_LITERAL(5, 57, 5), // "error"
QT_MOC_LITERAL(6, 63, 9), // "connected"
QT_MOC_LITERAL(7, 73, 12) // "disconnected"

    },
    "SerialPortManager\0messageReceived\0\0"
    "message\0errorOccurred\0error\0connected\0"
    "disconnected"
};
...
void SerialPortManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialPortManager::messageReceived)) {
                *result = 0;
                return;
            }
        }
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialPortManager::connected)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (SerialPortManager::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialPortManager::disconnected)) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 0
void SerialPortManager::messageReceived(const QString & _t1)
{
...
// SIGNAL 2
void SerialPortManager::connected()
{
